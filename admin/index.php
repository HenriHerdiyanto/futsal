...
<body>
  <div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index.php">Administrator <?php echo "$namaprofil"; ?></a>
                ...
                <footer class="application-footer">
                  <div class="container">
                    ...
                    <div class="disclaimer">
                      ...
                      <p>Distributed By <a href="http://blogbugabagi.blogspot.com" target="_blank" rel="noopener noreferrer"><b>BlogBugaBagi</b></a></p>
                    </div>
                  </div>
                </footer>
                <!-- /footer -->
