...
<?php
$angkas = '1';
$pp = mysqli_query($koneksi, "select * from profil where id_profil='$angkas'");
            ...
            <div class="row">
                ...
                <div class="span5">
                    ...
                    <form method=POST action="index.php?modul=aksi_jam&act=day" enctype='multipart/form-data'>
                        <?php
                        $id1 = '1';
                        $jmsiang = mysqli_query($koneksi, "select id_harga,harga from harga where id_harga='$id1'");
                        $bacasiang = mysqli_fetch_array($jmsiang);
                    ...
                    <form method=POST action="index.php?modul=aksi_jam&act=night" enctype='multipart/form-data'>
                        <?php
                        $id2 = '2';
                        $jmnight = mysqli_query($koneksi, "select id_harga,harga from harga where id_harga='$id2'");
                        $bacanight = mysqli_fetch_array($jmnight);
            ...
            <div class="row">
                <div class="span6">
                    <form method=POST action="index.php?modul=aksi_about&act=about" enctype='multipart/form-data'>
                        <?php
                        $id12 = '1';
                        $aabout = mysqli_query($koneksi, "select id_about,isi from about where id_about='$id12'");
                        $bacaabout = mysqli_fetch_array($aabout);
                ...
                <div class="span6">
                    <form method=POST action="index.php?modul=aksi_about&act=ketentuan" enctype='multipart/form-data'>
                        <?php
                        $id21 = '2';
                        $aketentuan = mysqli_query($koneksi, "select id_about,isi from about where id_about='$id21'");
                        $bacaketentuan = mysqli_fetch_array($aketentuan);
