          ...
          <div class="table-responsive">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                $tanggal = ($_POST["tgl"]);
                $a = mysqli_query($koneksi, "select jadwal.id_jadwal,jadwal.jam,jadwal.jams, harga.harga,harga.id_harga from jadwal,harga WHERE jadwal.id_harga=harga.id_harga order by jadwal.id_jadwal asc");
